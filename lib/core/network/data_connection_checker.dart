...
class DataConnectionChecker {
  ...
  static const Duration defaultInternal = Duration(seconds: 10);
  ...
  static final List<AddressCheckOptions> defauktAddresses = List.unmodifiable([
    AddressCheckOptions(
  ...
  List<AddressCheckOptions> addresses = defauktAddresses;
  ...
  ///
  /// Defaults to [defaultInternal] (10 seconds).
  Duration checkInterval = defaultInternal;
